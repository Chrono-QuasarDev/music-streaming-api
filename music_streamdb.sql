...
ALTER TABLE songs ADD FOREIGN KEY (artist_id) REFERENCES users (id) DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE follows ADD FOREIGN KEY (artist_id) REFERENCES users (id) DEFERRABLE INITIALLY IMMEDIATE;
